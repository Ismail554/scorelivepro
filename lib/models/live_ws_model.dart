class LiveScoreModel {
  ...
  /// 🧪 A realistic mock JSON of socket live matches response for testing.
  static const String demoJsonString = r'''
{
  ...
  "data": [
      ...
      "lineups": [
        {
          ...
          "coach": {
            "id": 18,
            "name": "Erik ten Hag",
            "photo": "https://media.api-sports.io/football/coaches/18.png"
          }
        }
      ],
      "statistics": [
    ...
    {
      "id": 1035243,
      "date": "2026-05-10T18:30:00+00:00",
      "timestamp": 1778437800,
      "timezone": "UTC",
